    ...
    <div class="container mt-5 w-75">
        <div class="card shadow">
            <div class="card-header bg-warning text-dark text-center">
                <h2 class="h4 mb-0">Ubah Mata Kuliah</h2>
            </div>
            <div class="card-body">
                <?php if (empty($data)) : ?>
                    <div class="alert alert-warning text-center">Tidak ada mata kuliah untuk diubah.</div>
                <?php else : ?>
                                ...
                                <?php foreach ($data as $mk) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="konfirmasiubahmk.php?kode=<?= urlencode($mk['kode']) ?>" class="btn btn-warning btn-sm">Ubah</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
