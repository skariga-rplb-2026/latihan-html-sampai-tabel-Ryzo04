...
} elseif (isset($_POST['tampilkan_semua'])) {
    $mahasiswa = ['__all__' => true];
}
?>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form method="post" class="row g-3">
                    ...
                    <div class="col-12">
                        <button type="submit" name="tampilkan_semua" class="btn btn-outline-primary w-100">Tampilkan Semua Data Mahasiswa</button>
                    </div>
                </form>
