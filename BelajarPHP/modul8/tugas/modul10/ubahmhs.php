...
<head>
    ...
    <title>Data Mahasiswa - Modul 10</title>
            ...
            <div class="card-body">
                                    ...
                                    <?php foreach ($data as $mhs) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a id="konfirm" href="konfirmasiubah.php?nim=<?= $mhs['nim'] ?>" class="btn btn-warning btn-sm">Edit</a>
                ...
                <div>
                    <div class="container mt-4 text-center">
                        <a href="../tambahmhs.php" class="btn btn-success px-5">Tambah Data Mahasiswa</a>
                    </div>
                </div>
            </div>
        </div>
